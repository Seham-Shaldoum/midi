...
let ctrls = {
    ...
    seafloor:"https://upload.wikimedia.org/wikipedia/commons/9/9b/Planets_everywhere_%28artist%E2%80%99s_impression%29.jpg",
    clr1: {r:550, g:100, b:22}, //color 1
    clr2:{ r:20, g:110, b:10}, //color 2
    d_range: {min: 1, max:20}, //range of sphere diameters
    explode_factor: 0.9, //explode distance
    light_intensity: 0.5
...
function triggerNote(note) {
    ...
    var sphere = BABYLON.MeshBuilder.CreateSphere("sphere", { diameter: random(ctrls.d_range.min, ctrls.d_range.max), segments: 100 }, scene);
    sphere.position.x = note.number + 6;
    sphere.position.y = Math.ceil(Math.random() * 1) + 5;
    sphere.position.z = Math.ceil(Math.random() * 1) +8 ;
...
keynotes[74] = {name:'G', octave:'3', number: 67}
keynotes[75] = {name:'A', octave:'5', number: 69}
...
var createScene = function () {
    ...
    groundTexture.vScale = groundTexture.uScale = 0.5;
    
    var groundMaterial = new BABYLON.StandardMaterial("groundMaterial", scene);
    groundMaterial.diffuseTexture = groundTexture;
    
    var ground = BABYLON.Mesh.CreateGround("ground", 320, 320, 220, scene, false);
    ground.position.y = -1;
    ground.material = groundMaterial;
        
    // Water
    var waterMesh = BABYLON.Mesh.CreateGround("waterMesh", 512, 51, 232, scene, false);
